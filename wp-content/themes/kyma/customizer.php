...
Kirki::add_field('kyma_theme', array(
    ...
    'description'             => __('Change Top bar Color', 'kyma'),
    'section'           => 'colors',
    'type'              => 'color',
    'priority'          => 9,
    'default'           => '#f9f9f9',
...
Kirki::add_field('kyma_theme', array(
    ...
    'output'            => array(
        array(
            'element'  => '#logo a h3, .light_header #navy > li > a, .menu_button_mode:not(.header_on_side) #navy > li.current_page_item:hover > a',
            'property' => 'color',
        ),
    ),
    'transport'         => 'postMessage',
    'js_vars'           => array(
        array(
            'element'  => '#logo a h3, .light_header #navy > li > a,  .menu_button_mode:not(.header_on_side) #navy > li.current_page_item > a, .menu_button_mode:not(.header_on_side) #navy > li.current_page_item:hover > a',
            'function' => 'css',
            'property' => 'color',
        ),
    ),
...
Kirki::add_field('kyma_theme', array(
    ...
    'description' => __('Seelect colored or default top bar', 'kyma'),
    'section' => 'header_sec',
    'priority' => 10,
    'transport' => 'postMessage',
    'default' => '',
...
Kirki::add_field('kyma_theme', array(
    ...
    'label' => __('Slider Two Effect', 'kyma'),
    'section' => 'service_sec',
    'type' => 'select',
    'priority' => 10,
    'transport' => 'postMessage',
