...
<section class="content_section bg_white">
	<div class="row_spacer clearfix">
		...
		<div class="content">
			...
			<!-- Filter Content -->
			<div class="hm_filter_wrapper four_blocks project_text_nav boxed_portos has_sapce_portos nav_with_nums upper_title upper_title">     
...
<section class="content_section bg_gray border_b_n">
	<div class="content row_spacer no_padding">	
		<div class="main_title centered upper">
			<h2><span class="line"><i class="ico-write"></i></span><?php _e('From The Blog', 'kyma'); ?></h2>
		</div>
